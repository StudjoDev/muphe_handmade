...
const products = [
  ...
  },
  {
    ...
    price: 1200,
    custom: true,
    crystals: "粉晶、海藍寶、白水晶、月光石",
    effect: "安撫、安心、溫柔陪伴",
    size: "依孩子手圍客製，珠徑與配件可依年齡調整",
    fit: "適合需要一點安全感、容易緊張，或正在適應新環境的孩子。",
    moment: "上學、外出、睡前故事時間配戴，像一個小小安心提醒。",
    care: "以白水晶碎石淨化，孩子配戴時建議由大人協助確認鬆緊與配件狀態。",
    pack: "手鍊、絨布袋、場景小卡、保養卡。",
    palette: ["#f0c4ca", "#b8d4df", "#d8a63f", "#fff7f1"],
  },
  {
    id: "child-guardian-brave",
    name: "小小勇氣守護款",
    scene: "兒童守護",
    type: "客制手鍊",
    color: "白金黑",
    price: 1200,
    custom: true,
    crystals: "白水晶、月光石、金曜石、茶晶",
    effect: "守護、勇氣、穩定情緒",
    size: "依孩子手圍客製，珠徑與配件可依年齡調整",
    fit: "適合容易受環境影響、需要建立勇氣與穩定感的孩子。",
    moment: "上學、才藝課、旅行或需要獨立面對新場合時配戴。",
    care: "避免拉扯與碰撞，配戴後以軟布擦拭並由大人協助收納。",
    pack: "手鍊、絨布袋、場景小卡、保養卡。",
    palette: ["#f7f3e9", "#d8a63f", "#2f2922", "#c7b9a5"],
  },
];
